    ...
    return (
        <main className="py-20 px-3">
            <div className="container mx-auto p-6">
                <h1 className="text-4xl font-bold text-center text-foreground mb-8">Terms and Conditions</h1>
                ...
                <section className="mb-6">
                    ...
                    <p className="text-foreground">For the purposes of these Terms and Conditions:</p>
                    <ul className="list-disc list-inside text-foreground space-y-4">
                        ...
                        <li>
                            ...
                            this Agreement) refers to EduEngine, Chandpol, Sikar (Rajasthan) -
                            332001.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Website</strong> refers to EduEngine, accessible from{" "}
                            <a
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold text-foreground">Disputes Resolution</h2>
                    <p className="text-foreground">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold text-foreground">For European Union (EU) Users</h2>
                    <p className="text-foreground">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold text-foreground">United States Legal Compliance</h2>
                    <p className="text-foreground">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold text-foreground">Severability and Waiver</h2>
                    ...
                    <h3 className="text-xl font-semibold text-foreground">Waiver</h3>
                    <p className="text-foreground">
                ...
                <section className="mb-6">
                    <h2 className="text-2xl font-semibold text-foreground">Translation Interpretation</h2>
                    <p className="text-foreground">
                ...
                <section className="mt-6">
                    ...
                    <ul className="list-disc list-inside text-foreground space-y-4">
                        <li>
                            By email: <a href="mailto:director@eduengine.com" className="text-blue-500 hover:underline">director@eduengine.com</a>
                        </li>
                        <li>
                            By visiting this page on our website:{" "}
                            <a
                                href="https://eduengine.in/contact-us"
                                rel="external nofollow noopener"
                                target="_blank"
                                className="text-blue-500 hover:underline"
                            >
                                https://eduengine.in/contact-us
                            </a>
                        </li>
                    </ul>
                </section>
